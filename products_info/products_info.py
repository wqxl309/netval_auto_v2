...
PRODUCTS_INFO = \
    [
        {'dlemail':True,'updtbase':True,'tkelement':True,'calcnet':True,'pname':'百泉一号','pcode':'SD8964','ipodate':dt.date(2015,12,30),'confirmdays':2,'precision':3,'nickname':'Baiquan1'},
        {'dlemail':True,'updtbase':True,'tkelement':True,'calcnet':True,'pname':'百泉二号','pcode':'SR3281','ipodate':dt.date(2016,11,24),'confirmdays':2,'precision':4,'nickname':'Baiquan2'},
        {'dlemail':True,'updtbase':True,'tkelement':True,'calcnet':True,'pname':'百泉三号','pcode':'SS1391','ipodate':dt.date(2017, 5,19),'confirmdays':2,'precision':4,'nickname':'Baiquan3'},
        ...
        {'dlemail':True,'updtbase':True,'tkelement':True,'calcnet':False,'pname':'烜鼎鑫诚九号','pcode':'SR0165','ipodate':dt.date(2016,12,7),  'confirmdays':2,'precision':4,'nickname':'Xuanding9'},
        {'dlemail':True,'updtbase':False,'tkelement':False,'calcnet':False,'pname':'星盈7号','pcode':'SM9136','ipodate':dt.date(2016,11,16), 'confirmdays':2,'precision':4,'nickname':'Xingying7'},
    ]
...
EMAIL_FILTER = \
    {
        ...
        '国道砺石二号':{'Subject':['SM8060','国道砺石二号','估值表'],'Attachment':['SM8060','国道砺石二号','估值表']},
